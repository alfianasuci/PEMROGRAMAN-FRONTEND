 ...
 */
const users = [
    { name : 'Felia', age : 21, major : 'Informatika' },
    { name : 'Isfa', age : 19, major : 'English'},
    { name : 'Nurul', age : 19, major : 'Sistem Informasi'},
    { name : 'Rendra', age : 20, major : 'Informatika'},
    { name : 'Tono', age : 20, major : 'Sistem Informasi'},
];
